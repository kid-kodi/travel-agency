...
const { isActiveSigner } = require("thirdweb/extensions/erc4337");
...
userSchema.statics.findByCredentials = async (phone, password, _id) => {
  let user = null;

  if (_id) {
    user = await User.findOne({ _id, phone });
  } else {
